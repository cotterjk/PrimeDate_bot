...
not only can every integer greater than 1 be represented as a product of primes, but each number has exactly one representation in this way. (122596 = 2 x 2 × 30649.)
