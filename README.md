...
not only can every integer greater than 1 be represented as a product of primes, but each number has exactly 1 representation this way. (122596 = 2 x 2 × 30649.)
