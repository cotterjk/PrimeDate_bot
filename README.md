...
not only can every integer greater than 1 be represented as a product of primes, but it can only be repesented like this in exactly one way. (122596 = 2 x 2 × 30649.)
